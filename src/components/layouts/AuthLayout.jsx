    ...
    return (
        <div className="flex">
            ...
            <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-center overflow-hidden p-8 relative">
                <div className="w-48 h-48 rounded-[40px] bg-purple-600 absolute -top-7 -start-5" />
                <div className="w-48 h-56 rounded-[40px] border-20 border-fuchsia-600 absolute top-[30%] -end-10" />
                <div className="w-48 h-48 rounded-[40px] bg-violet-500 absolute bottom-0 start-0" />
                <div className="grid grid-cols-1 z-20">
                    <StatsInfoCard
                        icon={<LuTrendingUpDown />}
                        label={t('trackYourIncomeAndExpense')}
                        value="430,000"
                        color="bg-purple-600"
                    />
                </div>
